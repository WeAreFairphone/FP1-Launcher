...
public class MenuTutorialAnimationView extends FrameLayout
{
    ...
    private void setupSwipeAnimation()
    {
        ...
        KWAnimation.KWValueAnimation xAnim = fingerSwipeAnimation.addValueAnimation(KWAnimation.KWValueType.X);
        ...
        xAnim = arrowSwipeAnimation.addValueAnimation(KWAnimation.KWValueType.X);
        ...
        KWAnimation.KWValueAnimation scaleAnim = menuSwipeAnimation.addValueAnimation(KWAnimation.KWValueType.Scale);
        scaleAnim.addKeyframe(0.8f, 600, null);
        scaleAnim.addKeyframe(1.0f, 800, decelerateInterpolator);
        alphaAnim = menuSwipeAnimation.addValueAnimation(KWAnimation.KWValueType.Alpha);
        ...
        animationGroupSwipe.setAnimationGroupListener(new KWAnimationGroup.KWAnimationGroupListener()
        {
            @Override
    ...
    private void setupAppOpenAnimation()
    {
        ...
        alphaAnim = rootAnimation.addValueAnimation(KWAnimation.KWValueType.Alpha);
        ...
        xAnim = handAnimation.addValueAnimation(KWAnimation.KWValueType.X);
        yAnim = handAnimation.addValueAnimation(KWAnimation.KWValueType.Y);
        scaleAnim = handAnimation.addValueAnimation(KWAnimation.KWValueType.Scale);
        ...
        alphaAnim = handShadowAnimation.addValueAnimation(KWAnimation.KWValueType.Alpha);
        ...
        alphaAnim = appIconAnimation.addValueAnimation(KWAnimation.KWValueType.Alpha);
        scaleAnim = appIconAnimation.addValueAnimation(KWAnimation.KWValueType.Scale);
        ...
        alphaAnim = appIconSelectedAnimation.addValueAnimation(KWAnimation.KWValueType.Alpha);
        scaleAnim = appIconSelectedAnimation.addValueAnimation(KWAnimation.KWValueType.Scale);
        alphaAnim.addKeyframe(0, 650, null);
        scaleAnim.addKeyframe(0.9f, 650, null);
        ...
        alphaAnim = menuAnimation.addValueAnimation(KWAnimation.KWValueType.Alpha);
        ...
        animationGroupSelectApp.setAnimationGroupListener(new KWAnimationGroup.KWAnimationGroupListener()
        {
            @Override
            public void onAnimationGroupStarted(KWAnimationGroup group)
            {
