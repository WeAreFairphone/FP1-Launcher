...
import community.fairphone.oobe.utils.KWAnimation;
import community.fairphone.oobe.utils.KWAnimationGroup;
import community.fairphone.oobe.utils.KWAnimationManager;
import community.fairphone.oobe.utils.KWSprite;
...
public class EditFavsTutorialAnimationView extends FrameLayout
{
    ...
    private void setupRemoveFavAnimation()
    {
        ...
        KWAnimation.KWValueAnimation alphaAnim;
        KWAnimation.KWValueAnimation xAnim;
        KWAnimation.KWValueAnimation yAnim;
        KWAnimation.KWValueAnimation scaleAnim;

        KWAnimation deleteHighlightAnimation = new KWAnimation(spriteDeleteHighlight);
        alphaAnim = deleteHighlightAnimation.addValueAnimation(KWAnimation.KWValueType.Alpha);
        ...
        xAnim = fingerAnimation.addValueAnimation(KWAnimation.KWValueType.X);
        yAnim = fingerAnimation.addValueAnimation(KWAnimation.KWValueType.Y);
        ...
        alphaAnim = fingerAnimation.addValueAnimation(KWAnimation.KWValueType.Alpha);
        ...
        alphaAnim = arrowAnimation.addValueAnimation(KWAnimation.KWValueType.Alpha);
        xAnim = arrowAnimation.addValueAnimation(KWAnimation.KWValueType.X);
        ...
        xAnim = favIconSelected2Animation.addValueAnimation(KWAnimation.KWValueType.X);
        xAnim.addKeyframe(0, startTime + 200, null);
        xAnim.addKeyframe(-238, startTime + 1200, accelerateDecelerateInterpolator);

        alphaAnim = favIconSelected2Animation.addValueAnimation(KWAnimation.KWValueType.Alpha);
        alphaAnim.addKeyframe(0, 100, null);
        ...
        animationGroupRemoveFav.setAnimationGroupListener(new KWAnimationGroup.KWAnimationGroupListener()
        {
            @Override
    ...
    private void setupAddFavAnimation()
    {
        ...
        animationGroupAddFav.setAnimationGroupListener(new KWAnimationGroup.KWAnimationGroupListener()
        {
            @Override
            public void onAnimationGroupStarted(KWAnimationGroup group)
            {
    ...
    private void setupMoveFavAnimation()
    {
        ...
        KWAnimation arrowAnimation = new KWAnimation(spriteArrow);
        yAnim = arrowAnimation.addValueAnimation(KWAnimation.KWValueType.Y);
        ...
        xAnim = favIconSelected1Animation.addValueAnimation(KWAnimation.KWValueType.X);
        xAnim.addKeyframe(0, startTime + 200, null);
        xAnim.addKeyframe(-30, startTime + 700, accelerateDecelerateInterpolator);
        xAnim.addKeyframe(0, startTime + 1200, accelerateDecelerateInterpolator);

        yAnim = favIconSelected1Animation.addValueAnimation(KWAnimation.KWValueType.Y);
        yAnim.addKeyframe(0, startTime + 200, null);
        yAnim.addKeyframe(286, startTime + 1200, accelerateDecelerateInterpolator);

        alphaAnim = favIconSelected1Animation.addValueAnimation(KWAnimation.KWValueType.Alpha);
        alphaAnim.addKeyframe(0, 100, null);
        alphaAnim.addKeyframe(1, startTime + 100, decelerateInterpolator);
        alphaAnim.addKeyframe(1, endTime - 100, null);
        alphaAnim.addKeyframe(0, endTime + 400, decelerateInterpolator);
        ...
        animationGroupMoveFav.setAnimationGroupListener(new KWAnimationGroup.KWAnimationGroupListener()
        {
            @Override
            public void onAnimationGroupStarted(KWAnimationGroup group)
            {
